        ...
        <b-card-body>
          <b-form @submit="onSubmit">
            <b-row align-v="center">
              ...
              <b-col cols="12" md="6" v-if="role.code == `user`">
                <b-row align-v="center" class="my-1">
                  <b-col cols="3">
...
export default {
  data() {
    return {
      ...
      description: null,
      role: { name: "کاربر سیستم", code: "client" },
      role_id: null,
      isLoading: false,
      roles: [
        { name: "مدیر سیستم", code: "admin" },
        { name: "پرسنل سیستم", code: "user" },
        { name: "کاربر سیستم", code: "client" },
      ],
      role_ids: [],
      form: {
        role: "client",
